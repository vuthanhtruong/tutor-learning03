...
public class GiaoVienPost {
    ...
    public String dangKyGiaoVien(
        ...
        List<Person> existingTeachersByEmail = entityManager
                .createQuery("SELECT t FROM Person t WHERE t.email = :email", Person.class)
        ...
        List<Person> existingTeachersByPhone = entityManager
                .createQuery("SELECT t FROM Person t WHERE t.phoneNumber = :phoneNumber", Person.class)
